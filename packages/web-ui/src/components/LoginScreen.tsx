...
export function LoginScreen({ onSignIn }: LoginScreenProps) {
  const handleGoogle = useCallback(() => onSignIn('google'), [onSignIn]);
  const handleGitHub = useCallback(() => onSignIn('github'), [onSignIn]);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = '#1a1a4e';
          }}
          onMouseLeave={(e) => {
      ...
      <p style={{
        ...
        Sign in to save your avatar and progress
      </p>
    </div>
  );
}
